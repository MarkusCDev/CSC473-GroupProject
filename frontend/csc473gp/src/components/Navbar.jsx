    ...
    <nav className="nav-container">
      <div className="nav-inner">
        <a href="/" className="flex items-center">
          <span className="self-center text-2xl font-semibold whitespace-nowrap">SoleSphere</span>
        </a>
        <button
          type="button"
        ...
        <div className={`${isMenuOpen ? '' : 'hidden'} w-full md:block md:w-auto`} id="navbar-solid-bg">
          <ul className="flex flex-col font-medium mt-4 rounded-lg dark:bg-neutral-700 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-transparent">
            {user ? (
              <>
