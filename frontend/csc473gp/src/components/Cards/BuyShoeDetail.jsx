...
function BuyShoeDetail() {
    ...
    const shoe = product.selling[0];  // Assuming each document has one shoe in `selling`
        ...
        <div className="bg-gray-100 dark:bg-gray-800 py-8">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row -mx-4">
                    ...
                    <div className="md:flex-1 px-4">
                        <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-2">{shoe.name}</h2>
                        ...
                        <div className="flex mb-4">
                            <div className="mr-4">
                                ...
                                <span className="text-gray-600 dark:text-gray-300">{shoe.price}</span>
                            </div>
                            <div>
