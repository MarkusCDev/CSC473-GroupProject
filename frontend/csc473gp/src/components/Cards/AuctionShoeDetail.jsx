                    ...
                    <div className="md:flex-1 px-4">
                        ...
                        <div className="flex -mx-2 mb-4">
                            <div className="w-full px-2">
                                <button onClick={handleAddToCart} className="w-full text-white py-2 px-4 rounded-full transition ease-in-out delay-150 hover:scale-105 duration-300 bg-blue-700 hover:bg-green-700 font-bold">Add to Cart</button>
                            </div>
                        </div>
                    </div>
                    <div className="md:flex-1 px-4">
